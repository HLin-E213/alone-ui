<script setup>
import baseMessageBox from './demo/baseMessageBox.vue';
import closeMessageBox from './demo/closeMessageBox.vue';
import confirmMessageBox from './demo/confirmMessageBox.vue'
</script>
# MessageBox 消息弹框
...
<baseMessageBox />
<show-code compName="messageBox" demoName="baseMessageBox" />       
...
<confirmMessageBox />
<show-code compName="messageBox" demoName="confirmMessageBox" />       
...
<closeMessageBox />
<show-code compName="messageBox" demoName="closeMessageBox" />       

## 按需引入
如果您需要按需引入 MessageBox
```javascript
 import { MessageBoxFn } from 'aloneUI'
```
...
> **Tip**<br>
> 功能没有完全和Element一致，最明显的，没有像上一个message那样每个类型出一个单独的方法了。。。
